...
function MovieDetails() {
  ...
  return info ? (
    <div style={{background:`linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.5),rgba(0,0,0,0.8)), url(https://image.tmdb.org/t/p/original/${info.detail.backdrop_path })`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }} className='relative w-screen h-[163vh] px-[10%] overflow-x-hidden '>
        {/* part-1 navigation */}
       ...
       <a target="_blank" href={`https://www.imdb.com/title/${info.externalid.imdb_id}`}>imdb</a>
        ...
        <div className='content ml-[8%] text-white'>
            <h1 className='text-4xl font-black text-white'>{info.detail.name ||
                 ...
                 <small className='text-xl font-bold text-zinc-200'>({info.detail.release_date.split("-")[0]})</small>
            </h1>
             ...
             <h1 className='text-2xl mt-3 mb-2'>Movie Languages</h1>
